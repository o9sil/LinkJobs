...
public class HireAnnouncementDetail {
	...
	public String toString() {
		return "HireAnnouncementDetail [hireAnnouncementNo=" + hireAnnouncementNo + ", company=" + company + ", title="
				+ title + ", career=" + career + ", education=" + education + ", workingFormName=" + workingFormName
				+ ", salary=" + salary + ", job=" + job + ", department=" + department + ", area=" + area + ", address="
				+ address + ", preferentialConditions=" + preferentialConditions + ", mainJob=" + mainJob
				+ ", contents=" + contents + ", startDate=" + startDate + ", endDate=" + endDate + ", manager="
				+ manager + ", industry=" + industry + ", numEmployees=" + numEmployees + ", establishDate="
				+ establishDate + ", ceo=" + ceo + ", pic=" + pic + "]";
	}
