...
public class MemberByResume {
	...
	private String resumeAvliability;
	...
	public String getResumeAvliability() {
		return resumeAvliability;
	}
	public void setResumeAvliability(String resumeAvliability) {
		this.resumeAvliability = resumeAvliability;
	}
