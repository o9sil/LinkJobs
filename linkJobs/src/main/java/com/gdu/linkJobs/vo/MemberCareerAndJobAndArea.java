...
public class MemberCareerAndJobAndArea {
   ...
   public int getArea2No() {
      return area2No;
   }
   public void setArea2No(int area2No) {
   ...
   public String toString() {
      return "MemberCareerAndJobAndArea [careerNo=" + careerNo + ", memberId=" + memberId + ", careerCompanyName="
            ...
            + careerJobgradeJobpositionYear + ", jobNo=" + jobNo + ", jobCategory=" + jobCategory + ", job2No="
            + job2No + ", job2Category=" + job2Category + ", job3No=" + job3No + ", job3Category=" + job3Category
            + ", areaNo=" + areaNo + ", areaSido=" + areaSido + ", area2No=" + area2No + ", area2Gungu="
            + area2Gungu + ", careerDepartment=" + careerDepartment + ", careerSalary=" + careerSalary
